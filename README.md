...
- **Optional client conversion override:** Clients can enable **Use my conversion settings (advanced)** in the lobby when they intentionally want their own instrument or arrangement. It is off by default, resets when leaving the room, and warns that locally generated channel roles may differ from the host's assignments.
